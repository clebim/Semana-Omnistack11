...
export default function Detail() {
  ...
  const message = `Olá ${incident.name}, estou entrando em contato para ajuda o
  caso no valor de ${Intl.NumberFormat('pt-BR',
  ...
  function sendWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=34998711646text=${message}`);
  }
